 ...
 */
public class EmergencyContactHandler implements Runnable {

    public static final int EMERGENCY_CONTACT_HANDLER = 1002;
    private static final String TAG = "EmergencyContactHandler";
    private Handler handler;
    private Activity mActivity;

    public EmergencyContactHandler(Handler handler, Activity mActivity) {
...
//    }
    ...
    private void handleEmergencyResponse(MenuDTO menuDTO) {
        Utils.ShowLog(TAG, "handleMenuCountResponse");
        Message msg = handler.obtainMessage(EMERGENCY_CONTACT_HANDLER, menuDTO);
