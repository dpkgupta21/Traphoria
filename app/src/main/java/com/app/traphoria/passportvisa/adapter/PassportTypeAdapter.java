...
public class PassportTypeAdapter extends BaseAdapter {
    private Context context;
    private List<PassportTypeDTO> passportTypeList;


    public PassportTypeAdapter(Context context, List<PassportTypeDTO> passportTypeList) {
    ...
    @Override
    public int getCount() {
        return passportTypeList.size();
    }

    @Override
    public Object getItem(int position) {
        return passportTypeList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtCountryCode.setText(passportTypeList.get(position).getName());
