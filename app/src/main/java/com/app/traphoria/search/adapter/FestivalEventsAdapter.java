...
public class FestivalEventsAdapter extends RecyclerView.Adapter<FestivalEventsAdapter.DetailsViewHolder> {
    ...
    public FestivalEventsAdapter(Context context, List<FestivalDTO> festivalList) {
    ...
    public void onBindViewHolder(DetailsViewHolder holder, int position) {
        ...
        ImageLoader.getInstance().displayImage(festivalList.get(position).getImage(), holder.thumbnail,
                options);
        holder.date_tv.setText(festivalList.get(position).getStart_date() + " to " + festivalList.get(position).getEnd_date());
