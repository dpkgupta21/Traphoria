...
public class FestivalEventDetailScreen extends BaseActivity {
    ...
    private void setFestivalEventDetails(FestivalDTO festivalDTO) {
        ...
        txtStartDate.setText(festivalDTO.getStart_date());

        TextView txtEndDate = (TextView) findViewById(R.id.txt_end_date);
        txtEndDate.setText(festivalDTO.getEnd_date());

        TextView txtEventTitle = (TextView) findViewById(R.id.txt_event_title);
        txtEventTitle.setText(festivalDTO.getTitle());
