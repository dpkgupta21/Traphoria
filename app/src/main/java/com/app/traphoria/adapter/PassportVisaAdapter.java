 ...
 */
public class PassportVisaAdapter extends RecyclerView.Adapter<PassportVisaAdapter.DetailsViewHolder> {


    @Override
    public DetailsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.passport_visa_row_layout, parent, false);
